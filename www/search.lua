...
for k,v in pairs(res) do
	print([[
		<div style="border-style: solid; position: relative; border-width: 4px; border-color:000000; background-color:#303030; width:128px; width:90%; margin: 0 auto; padding:16px;"><a href="update.lua?project=]]..v[2]..[[&id=]]..v[1].index..[[">
			<div style="font-size:25px; color:#EEEEEE; vertical-align:bottom;"><img src="]]..htmlencode(v[1].image)..[[" width=128 height=128 style="border-style: solid; position: relative; border-width: 4px; border-color:000000; float:left; margin-right:16px;"/>
